...
import { Connection as SolanastaticJsonRpcProvider } from "@solana/web3.js"
...
export const solanaBaseProvider = new SolanastaticJsonRpcProvider(config.baseNetworkHttpUrl, "confirmed");
